      ...
      <div class="tbl-cont p-4 col-lg-4">
        ...
        <!-- <div class="tableFilters">
          <input class="input" type="text" v-model="tableData.search" placeholder="Search Table"
                  @input="getStudentsPayment()">
          <div class="control">
            <div class="select">
              <select v-model="tableData.length" @change="getStudentsPayment()">
        ...
        <pagination :pagination="pagination"
                    @prev="getStudentsPayment(pagination.prevPageUrl)"
                    @next="getStudentsPayment(pagination.nextPageUrl)">
        </pagination>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getStudentsPayment(url = process.env.MIX_BASE_URL+'/admins/badge-list'){
      this.tableData.draw++;
