<template>
  <div>
      ...
      <b-card v-for="ld in lpSData" :key="ld.id">
        ...
        <b-row class="mb-3">
          ...
          <b-col cols="2" class="font-14 pl-1">
            <b-button variant="outline-warning" size="sm" class="float-right w-100 rounded-0"><i class="fas fa-bookmark"></i> Bookmark </b-button> 
          </b-col>
        </b-row>
        <b-card-text>
    ...
    <b-modal id="modal-center" title="Rate" hide-footer>
