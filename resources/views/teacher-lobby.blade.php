        ...
        <teaching-strategies></teaching-strategies>
			...
			<div class="col-lg-3 col-md-3 offset-lg-1 pr-0">
				<div class="cont-home-works">
					<div class="head-upcoming-lesson bg-dark mb-0 pb-2 pt-3 pl-3"><h5 class="font-weight-regular">Filters <span class="float-right pr-2" style="line-height: 1.5"><i class="fas fa-chevron-right"></i></span></h5></div>
