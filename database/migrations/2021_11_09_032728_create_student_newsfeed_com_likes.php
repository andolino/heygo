...
class CreateStudentNewsfeedComLikes extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_newsfeed_com_likes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('student_newsfeed_com_likes');
    }
}
