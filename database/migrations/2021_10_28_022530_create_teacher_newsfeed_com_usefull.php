...
class CreateTeacherNewsfeedComUsefull extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('teacher_newsfeed_com_usefull', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamps();
            $table->foreign('teacher_newsfeed_com_id', 'fk_tchr_nwsd_com_id')->references('id')->on('teacher_newsfeed_comments')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('teacher_newsfeed_com_usefull');
    }
}
