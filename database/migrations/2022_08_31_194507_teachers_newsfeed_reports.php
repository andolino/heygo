...
class TeachersNewsfeedReports extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('teacher_newsfeed_reports', function (Blueprint $table) {
            $table->id();
            ...
            $table->boolean('is_reported')->default(0)->comment('0 => disliked, 1 => liked');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('teacher_newsfeed_reports');
    }
}
