...
class CreateTeachingStrategyRatings extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('teaching_strategy_ratings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('teaching_strategy_ratings');
    }
}
