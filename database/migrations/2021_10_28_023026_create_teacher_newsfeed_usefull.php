...
class CreateTeacherNewsfeedUsefull extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('teacher_newsfeed_usefull', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('teacher_newsfeed_usefull');
    }
}
