...
class CreateStudentNewsfeedUsefull extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_newsfeed_usefull', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('student_newsfeed_usefull');
    }
}
